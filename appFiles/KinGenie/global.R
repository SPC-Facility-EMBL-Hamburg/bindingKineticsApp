...
if (isMac) {
  ...
  base_dir <- paste0("/Users/",user,"/Desktop/arise/spc_shiny_servers/kineticsApp/appFiles/",appName,"/")
  
} else {
  reticulate::use_python(paste0("/home/",user,"/myenv/bin/python"), required = TRUE)
  base_dir <- paste0("/home/",user,"/spc_shiny_servers/kineticsApp/appFiles/",appName,"/")
}
